...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "你好!欢迎来到Gabbit,我们的目标是通过友好的对话为您提供考虑周到的解答.\r\n为了保护您的数据隐私，所有的数据都只存在您自己的浏览器里，Gabbit不做任何存储" //"访问密码不正确或为空，请前往[登录](/#/auth)页输入正确的访问密码，或者在[设置](/#/settings)页填入你自己的 OpenAI API Key。",
  },
  Auth: {
    Title: "需要密码",
